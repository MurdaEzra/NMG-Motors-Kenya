...
const VehiclesPage = () => {
  ...
  const handleFilterChange = (filters: FilterOptions) => {
    ...
    setTimeout(() => {
      ...
      const searchFiltered = searchTerm ? filtered.filter(car => `${car.brand} ${car.model}`.toLowerCase().includes(searchTerm.toLowerCase())) : filtered;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <div className="relative">
            <input type="text" placeholder="Search by brand or model..." value={searchTerm} onChange={handleSearchChange} className="w-full p-3 pl-10 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#A3320B] focus:border-transparent" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            {isLoading ? <div className="flex justify-center items-center h-64">
              ...
              </div> : filteredCars.length > 0 ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
